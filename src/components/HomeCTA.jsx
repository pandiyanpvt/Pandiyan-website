...
export default function HomeCTA() {
    return (
        <section className="py-12 sm:py-16 md:py-20 lg:py-24 2xl:py-32 bg-[#1a1f3c] relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-20 3xl:px-24 4xl:px-32 relative z-10 text-center max-w-[1920px]">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    className="bg-gradient-to-r from-yellow-500/20 to-purple-500/20 backdrop-blur-sm border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 2xl:p-20 max-w-4xl 3xl:max-w-5xl 4xl:max-w-6xl mx-auto"
                >
                    <Users className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 2xl:w-24 2xl:h-24 text-yellow-400 mx-auto mb-4 sm:mb-6" />
                    <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-black text-white mb-4 sm:mb-6 leading-tight">
                        Ready to <span className="text-[#f39c12]">Start Your Next</span> Project?
                    </h2>
                    <p className="text-blue-100/70 text-xs sm:text-sm md:text-base lg:text-base xl:text-lg 2xl:text-xl mb-6 sm:mb-8 max-w-2xl 3xl:max-w-3xl mx-auto">
