...
export default function ApplyModal({ isOpen, onClose, jobTitle }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            {/* Modal Content */}
            <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white border border-neutral-100 rounded-2xl sm:rounded-3xl shadow-2xl transform transition-all animate-in fade-in zoom-in duration-300">
                <div className="sticky top-0 right-0 z-10 flex justify-end p-3 sm:p-4 bg-white/95 backdrop-blur-sm border-b border-neutral-100 sm:absolute sm:top-4 sm:right-4 sm:border-0 sm:bg-transparent sm:backdrop-blur-none">
                    <button
                        onClick={onClose}
                        className="text-neutral-400 hover:text-neutral-900 p-2 rounded-full hover:bg-neutral-100 transition-colors touch-manipulation"
                    >
